...
public static void main(String[] args) {
	...
	System.out.println("나는 말하는 것을 좋아한다. 맞으면 o 틀리면 x");
	mbtiResult[0]=Integer.parseInt(sc.nextLine()=="o"?"0":"1");
	System.out.println("나는 숲보다는 나무를 본다. 맞으면 o 틀리면 x");
	mbtiResult[1]=Integer.parseInt(sc.nextLine()=="o"?"0":"1");
	System.out.println("나는 일보다 대인관계를 중요하게 여긴다. 맞으면 o 틀리면 x");
	mbtiResult[2]=Integer.parseInt(sc.nextLine()=="o"?"0":"1");
	System.out.println("나는 과정보다 결과가 중요하다. 맞으면 o 틀리면 x");
